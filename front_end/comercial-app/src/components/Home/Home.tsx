...
const Home = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="overflow-hidden min-h-[1000px] lg:min-h-0 h-screen w-scren bg-slate-100 flex justify-center items-center"
      >
        <div className="flex flex-col justify-center">
          <div className="flex lg:flex-row flex-col-reverse  flex-wrap-reverse md:justify-between justify-center items-center">
            <div className="flex flex-col justify-center items-center content-center max-w-[600px] mr-5 lg:mt-0 mt-4 ">
          ...
          <div className="flex flex-row flex-wrap lg:justify-start justify-center lg:w-[100%] w-[99.9%] gap-x-6 mt-6">
            <p className="text-slate-700  md:pr-0 pb-6 lg:text-base text-xl">
              Stack Tecnológico |{" "}
            </p>
            <ul className="flex flex-row flex-wrap justify-center max-w-[80%] ">
              <li>
                <div
                  className="mx-5 lg:mt-0 mt-4  bg-slate-50 shadow-xl rounded-full "
                  title="HTML5"
                >
              ...
              <li>
                <div
                  className="mx-5 lg:mt-0 mt-4 bg-slate-50  shadow-xl rounded-full pt-1.5  pb-1"
                  title="Tailwind"
                >
                  <img
                    className=" w-12 p-2"
      ...
      <section
        id="about"
        className="scroll-smooth transition-all duration-50 h-screen w-screen bg-slate-50 flex justify-center items-center"
      ></section>
    </>
  );
};
