    ...
    <>
      <div className="flex flex-initial">
        <div className="flex flex-col justify-items-center w-[100vw]">
          ...
          <div className="my-5 bg-no-repeat shrink-0 bg-center bg-contain bg-[url('src/assets/projects/Screenshot_2023-06-30_01-59-46.png')] xl:w-[37vw] sm:w-[90%] w-[100%] h-[42vh] hover:bg-[url('https://user-images.githubusercontent.com/85205823/192325244-1e46ba81-e6da-4f26-b3f0-ff3fd068a8eb.gif')] rounded-2xl" />
          ...
          <div className="flex xl:flex-row flex-column  flex-wrap xl:m-10 m-0 justify-center items-center 2xl:mx-[300px] shadow-xl bg-slate-50 rounded-2xl ">
              ...
              <div className="bg-no-repeat my-5 shrink-0 xl:order-2 bg-center bg-contain bg-[url('src/assets/projects/Screenshot_2023-06-30_07-33-24.png')] xl:w-[37vw] sm:w-[90%] w-[100%] h-[42vh] hover:bg-[url('src/assets/projects/simplescreenrecorder-2-6uyah0kx_OUzpg5UW.gif')] rounded-2xl" />
